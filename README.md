...
seed mode, so winning or losing no longer blocks the player until the next day.
The old share action has been removed; in its place there is a **Resetta**
button that clears saved statistics and starts over with a new game.

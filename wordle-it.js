      ...
      ss = function(e) {
          ...
          return o(t, [{
	          ...
	          value: function(e) {
	                  ...
	                  a.removeAttribute("persistent"), a.removeAttribute("open"), this.clearToasts(), this.boardState = new Array(6).fill(""), this.evaluations = new Array(6).fill(null), this.rowIndex = 0, this.tileIndex = 0, this.canInput = !0, this.gameStatus = Qa, this.letterEvaluations = {}, this.gameSeed = void 0 === e ? Zb() : e >>> 0, this.solution = void 0 === e ? Pa(this.gameSeed, this.solution) : Pa(this.gameSeed), this.dayOffset = Na(this.solution), this.restoringFromLocalStorage = !1, this.$keyboard.reset(), this.$board.innerHTML = "";
                  for (var a = 0; a < 6; a++) {
              ...
              value: function() {
	              ...
	              key: "clearToasts",
	              value: function() {
	                  this.shadowRoot.querySelector("#game-toaster").innerHTML = "", this.shadowRoot.querySelector("#system-toaster").innerHTML = ""
	              }
	          }, {
	              key: "sizeBoard",
	              value: function() {
      ...
      function t() {
	      ...
	      return o(t, [{
	          ...
	          value: function() {
	              ...
	              var a = this.shadowRoot.querySelector(".overlay");
